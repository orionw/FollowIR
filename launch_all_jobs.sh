...
do
    ...
    qsub -N rerank -j y -o "$PWD/logs/$file_safe_model_name/rerank.out.$((`date '+%s%N'`/1000))" -l h_rt=96:00:00,gpu=1 -q gpu.q@@a100 launch_jobs.sh --model_name $model --batch_size 8
done
